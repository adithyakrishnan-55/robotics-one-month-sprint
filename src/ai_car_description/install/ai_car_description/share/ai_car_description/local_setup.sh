...
: ${AMENT_CURRENT_PREFIX:="/ai_car_ws/src/ai_car_description/install/ai_car_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ai_car_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ai_car_description/environment/path.sh"
